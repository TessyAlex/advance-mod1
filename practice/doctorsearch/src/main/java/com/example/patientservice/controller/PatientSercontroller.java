...
public class PatientSercontroller {
	...
	public List<Doctor> patient() {
		...
		String url1="http://localhost:8094/doctor/retrieve";// we should give the port no of gateway and 
//		endpoint of the destination service that is the doctorservice.
